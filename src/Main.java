...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            reponseRelancer = clavier.nextLine().toUpperCase();
        } while (reponseRelancer.equals("O") || reponseRelancer.equals("OUI"));
        System.out.println("Merci Beaucoup d'avoir joué !");
